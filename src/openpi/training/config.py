...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_fast_libero_low_mem_finetune_subset",
        ...
        data=LeRobotLiberoDataConfig(
            repo_id="Varun0157/libero-stuff",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_fast_base/params"),
        num_train_steps=500,
    ...
    TrainConfig(
        ...
        data=RLDSDroidDataConfig(
            repo_id="droid",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            rlds_data_dir="/scratch2/cross-emb/openpi/x_arm_sim_dataset",
            action_space=droid_rlds_dataset.DroidActionSpace.JOINT_POSITION,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_fast_base/params"),
        num_train_steps=1000,  # 100k steps should be sufficient, takes ~2 days on 8x H100s
        batch_size=64,
        save_interval=250,
        num_workers=0,  # Important: RLDS DataLoader requires num_workers=0, handles multi-processing internally
        freeze_filter=pi0_fast.Pi0FASTConfig(
    ...
    TrainConfig(
        ...
        data=RLDSDroidDataConfig(
            repo_id="droid",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            rlds_data_dir="/scratch2/cross-emb/openpi/x_arm_real_dataset",
